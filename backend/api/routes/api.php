...
Route::get('/tipo_habitaciones_acomodaciones/{id}', [TipoHabitacionesAcomodacionesController::class, 'showBelongs']);
Route::post('/tipo_habitaciones_acomodaciones/{id}', [TipoHabitacionesAcomodacionesController::class, 'storeTypeAcc']);
